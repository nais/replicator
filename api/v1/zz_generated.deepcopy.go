...
func (in *ReplicationConfigSpec) DeepCopyInto(out *ReplicationConfigSpec) {
	*out = *in
	...
	if in.ValueSecrets != nil {
		in, out := &in.ValueSecrets, &out.ValueSecrets
		*out = make([]ValueSecret, len(*in))
		copy(*out, *in)
	}
	if in.Resources != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValueSecret) DeepCopyInto(out *ValueSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValueSecret.
func (in *ValueSecret) DeepCopy() *ValueSecret {
	if in == nil {
		return nil
	}
	out := new(ValueSecret)
